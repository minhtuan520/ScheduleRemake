...
using ScheduleRemake.Authorization;
using ScheduleRemake.Helpers;
using ScheduleRemake.ViewModels;
...
namespace ScheduleRemake
{
    public class Startup
    {
        ...
        {
            services.AddDbContext<tkbremake4DbContext>(options =>
            {
                options.UseSqlServer(Configuration["ConnectionStrings:DefaultConnection"], b => b.MigrationsAssembly("ScheduleRemake"));
                options.UseOpenIddict();
            });

            // add identity
            services.AddIdentity<ApplicationUser, ApplicationRole>()
                .AddEntityFrameworkStores<tkbremake4DbContext>()
            ...
            services.AddOpenIddict()
                .AddCore(options =>
                {
                    options.UseEntityFrameworkCore().UseDbContext<tkbremake4DbContext>();
                })
                .AddServer(options =>
                {
                    options.UseMvc();
        ...
        public void Configure(IApplicationBuilder app, IHostingEnvironment env, ILoggerFactory loggerFactory)
        {
            ...
            app.UseSwaggerUI(c =>
            {
                ...
                c.SwaggerEndpoint("/swagger/v1/swagger.json", "ScheduleRemake API V1");
            });
